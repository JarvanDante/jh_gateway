...
# 
api_key="B9ov28B5BICjkqK3OFd1gM2Mks6kIyEu231242625" 			#api_key
api_token="gBHtZyvVOxMyU0M3UoVky5oxQaPMY0k7448338556" 	#api_token
url="https://www.showdoc.com.cn/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#url="https://doc.mduat.net/server/index.php?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
