...
type GetAdminListReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // 用户名筛选 (可选)
	Status        int32                  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`    // 状态筛选 (可选)
...
type GetAdminListRes struct {
	...
	Google2FaAccess bool                   `protobuf:"varint,5,opt,name=google2fa_access,json=google2faAccess,proto3" json:"google2fa_access,omitempty"` // Google 2FA 权限
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type UpdateAdminReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            int32                  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`            // 管理员ID
	...
	Role          int32                  `protobuf:"varint,4,opt,name=role,proto3" json:"role,omitempty"`        // 角色 (可选)
	Status        int32                  `protobuf:"varint,5,opt,name=status,proto3" json:"status,omitempty"`    // 状态 (可选)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetAdminLogsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Username      string                 `protobuf:"bytes,1,opt,name=username,proto3" json:"username,omitempty"` // 用户名筛选 (可选)
	Start         string                 `protobuf:"bytes,2,opt,name=start,proto3" json:"start,omitempty"`       // 开始时间 (可选)
	End           string                 `protobuf:"bytes,3,opt,name=end,proto3" json:"end,omitempty"`           // 结束时间 (可选)
...
type AdminLogInfo struct {
	...
	Remark        string                 `protobuf:"bytes,3,opt,name=remark,proto3" json:"remark,omitempty"`                        // 操作备注
...
type GetAdminLogsRes struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          []*AdminLogInfo        `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`    // 日志列表
	Count         int32                  `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"` // 总数量
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_backend_admin_v1_admin_proto_rawDesc = "" +
	...
	"\fGetAdminLogs\x12\x16.admin.GetAdminLogsReq\x1a\x16.admin.GetAdminLogsRes\"\x00B!Z\x1fjh_gateway/api/backend/admin/v1b\x06proto3"
