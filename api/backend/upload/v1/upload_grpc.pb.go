...
func (c *uploadClient) UploadImage(ctx context.Context, in *UploadImageReq, opts ...grpc.CallOption) (*UploadImageRes, error) {
...
func (UnimplementedUploadServer) UploadImage(context.Context, *UploadImageReq) (*UploadImageRes, error) {
...
var Upload_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "backend/upload/v1/upload.proto",
}
